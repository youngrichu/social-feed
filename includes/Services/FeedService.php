...
class FeedService {
                ...
                foreach ($platforms as $platform) {
                    try {
                        ...
                        if (!$platform_handler) {
                            ...
                            $platform_errors[$platform] = "Platform handler not found";
                            continue;
                        }

                        if (!$platform_handler->is_configured()) {
                            error_log("FeedService: Platform $platform is not properly configured");
                            $platform_errors[$platform] = "Platform is not properly configured";
                            continue;
                        }
                        ...
                        if (!is_array($platform_items)) {
                            ...
                            $platform_errors[$platform] = "Invalid platform response";
                            continue;
                        }
                        ...
                        $platform_errors[$platform] = $e->getMessage();
                    }
                }
    ...
    private function get_enabled_platforms() {
        ...
        $enabled = array_keys(array_filter($platforms, function($platform) {
